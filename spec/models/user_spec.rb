...
RSpec.describe User, type: :model do
  subject { User.new(name: 'emmanuella', photo: 'emmanuella Photo URL', bio: 'front end devops', posts_counter: 8) }
  ...
  it 'expects the bio to have a valid value' do
    expect(subject.bio).to eql 'front end devops'
  end

  it 'expect photo to have a valid value' do
    expect(subject.photo).to eql 'emmanuella Photo URL'
  end
